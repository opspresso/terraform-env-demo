...
[`demo/9-tailscale-exit`](demo/9-tailscale-exit/README.md) creates an Oregon
`t4g.nano` exit node. Select `tailscale-exit` in a Tailscale client
to route internet traffic through its US public IP.
